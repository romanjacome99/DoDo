...
# Estos son para el FC-AIDE
from tensorflow.keras.models import Sequential, Model
from tensorflow.keras.layers import Dense, Dropout, Flatten, Activation, Add, Input, Average
...
class EncoderMiniBlock(Layer):
    def __init__(self, n_filters=32, dropout_prob=0.3, max_pooling=True, name='DecoderBlock'):
